      ...
      <div className="home_container">
        <div className="home_wrapper">
          <div className="home_title">
            <h2>
              Welcome to our bath tub refinishing services, where we specialize
              in transforming your bathroom into a beautiful and luxurious
              space. Our team of experts are dedicated to providing
              high-quality, affordable and long-lasting refinishing solutions
              for your bath tub.
            </h2>
          </div>
          <div className="home_form">
            ...
            <div className="home_link">
              <a
                href="https://www.facebook.com/diamondkztubrefinishing"
